...
else if(t.closest('.bottom')){if(x.includes('home')){k='home-nav';u='/atelier-v2/'}else if(x.includes('academy')){k='academy-nav';u='/atelier-v2/academy-v2.html'}else if(x.includes('clients')){k='clients-nav';u='/atelier-v2/clients.html'}else if(x.includes('profile')){k='profile-nav';u='/app/workspace.html?view=profile'}else if(t.classList.contains('fab')||t.classList.contains('create')||x==='✦'){k='create-nav';u='/atelier-v2/create.html'}else return}
