...
window.FUSE = {
  ...
  VIDEO_MODELS: [
    ...
    { slug: 'kling-v3-turbo-pro-text-to-video',     name: 'Kling Turbo Pro', badge: 'Kuaishou',  credits: 88, sample: '/app/media/avatar-tile.mp4' },
    { slug: 'veo3-text-to-video',                   name: 'Veo 3',           badge: 'Google',    credits: 150, sample: '/app/media/hero.mp4' },
    { slug: 'seedance-2-vip-text-to-video',         name: 'Seedance 2 VIP',  badge: '4K · premium', credits: 188, sample: '/app/media/fashion.mp4' },
  ],
  TOOL_MODELS: [
