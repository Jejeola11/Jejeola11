...
window.FUSE = {
  ...
  IMAGE_MODELS: [
    ...
    { slug: 'nano-banana-pro',       name: 'Nano Banana Pro', badge: 'Google',   credits: 10, sample: '' },
    { slug: 'gpt-image-2',           name: 'GPT Image 2',    badge: 'OpenAI',    credits: 10, sample: '' },
    { slug: 'recraft-v3',            name: 'Recraft V3',     badge: 'Recraft',   credits: 8,  sample: '' },
    { slug: 'ideogram-v3',           name: 'Ideogram V3',    badge: 'Ideogram',  credits: 8,  sample: '' },
    { slug: 'hidream_i1_full_image', name: 'HiDream',        badge: 'HiDream',   credits: 8,  sample: '' },
    { slug: 'z-image',               name: 'Z-Image',        badge: 'Z',         credits: 5,  sample: '' },
