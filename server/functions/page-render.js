...
exports.handler = async (event) => {
  try{
    ...
    return json(200,{ok:true,html:renderSite(q.data.site_spec||{}, {preview:true,editor:true}),project:{id:q.data.id,title:q.data.title,status:q.data.status,slug:q.data.slug}});
  }catch(e){
